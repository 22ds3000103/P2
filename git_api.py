...
def GA2_3(question):
    ...
    trigger_github_workflow(
        token=token, repo="22ds3000103/VATCHALA", workflow_file="daily_commit.yml"
    )  # Trigger the workflow after
    time.sleep(15)
    return "https://22ds3000103.github.io/VATCHALA/"
...
async def GA2_6_file(file: UploadFile = File(...)):
    ...
    response = github_write_file(
        token, "22ds3000103/ga1", file_path_on_github, file_content
    )
...
async def GA2_9_file(file: UploadFile = File(...)):
    ...
    # Upload the file to GitHub
    response = github_write_file(
        token, "22ds3000103/tds_ga2_9", file_path_on_github, file_content
    )
...
def GA2_7(question):
    ...
    github_replace_text(
        token=token,
        repo="22ds3000103/vat23_github-action-test",
    ...
    trigger_github_workflow(
        token=token, repo="22ds3000103/vat23_github-action-test", workflow_file="Daily_Commit.yml"
    )
    time.sleep(15)
...
def GA4_8(question):
    return "https://github.com/22ds3000103/tdsga4"
